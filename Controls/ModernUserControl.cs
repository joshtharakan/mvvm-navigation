...
using ModernUIForWPFSample.Navigation__MVVM_.ViewModel;
...
namespace ModernUIForWPFSample.Navigation__MVVM_.Controls
{
    ...
    {
        private static string Resourcetag = "Resources";
        /// <summary>
        ...
        public void OnNavigatedTo(NavigationEventArgs e)
        {
            if (this.Name == "Steps")
            {
                ViewModelLocator vm = Application.Current.FindResource("Locator") as ViewModelLocator;
                this.DataContext = vm.StepsViewModel;

            }
            else if (this.Name.Equals(Resourcetag))
            {
                ViewModelLocator vm = Application.Current.FindResource("Locator") as ViewModelLocator;
                this.DataContext = vm.ResourcesViewModel(Resourcetag);
