...
namespace ModernUIForWPFSample.Navigation__MVVM_.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public ResourcesViewModel ResourcesViewModel(string name)      
        {
           

              //      var uniqueKey = Guid.NewGuid().ToString();
                return SimpleIoc.Default.GetInstance<ResourcesViewModel>(name);
        ...
        public StepsViewModel StepsViewModel
        {
            get
            {
                return SimpleIoc.Default.GetInstance<StepsViewModel>();
            }
        }
